        ...
        <div class="project-content">
          ...
          <div class="project-actions">
            ...
            <div class="project-external-links">
              <a class="button button-icon-only" href="${project.repoLink}" target="_blank" aria-label="Ver repositório no GitHub"><i class="fab fa-github"></i></a>
              <a class="button button-icon-only" href="${project.liveLink}" target="_blank" aria-label="Ver projeto online"><i class="fas fa-external-link-alt"></i></a>
            </div>
          </div>
        </div>
      </div>
